...
// /// Provides the [PlayerProgress]
// final pPlayerProgress =
//     NotifierProvider.autoDispose<PlayerProgress, List<int>>(() {
//   return PlayerProgress();
// });
//
// /// Encapsulates the player's progress.
// class PlayerProgress extends AutoDisposeNotifier<List<int>> {
...
//   List<int> get levels => state;
//
//   /// Fetches the latest data from the backing persistence store.
//   Future<void> getLatestFromStore() async {
//     final store = ref.watch(pLocalStoragePlayerProgress);
//     final levelsFinished = await store.getFinishedLevels();
...
final pPlayerProgress = ChangeNotifierProvider<PlayerProgress>((ref) {
  return PlayerProgress();
});

// TODO migrate this to a Notifier or AsyncNotifier
